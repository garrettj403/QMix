...
params = {'analyze':        None,    # analyze the data?
          ...
          'comment':        '',      # add a comment to this instance (no effect on data
          'cut_low':        0.25, 
          'cut_high':       0.2, 
          ...
          'ifdata_sigma':   5,       #
          'ifdata_vmax':    2.25,
          'igap_guess':     0.0002,  # gap current guess (used for initial filter)
          'npts':           6001,    
          'remb_range':     (0, 1),
          ...
          't_cold':         80.,
          't_hot':          295.,
          'usecols':        (0, 1),  # voltage and current columns for read in data
          ...
          'voffset_sigma':  1e-5,
          'vgap_guess':     2.7e-3,  # gap voltage guess (used for initial filter)
